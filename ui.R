...
shinyUI(navbarPage(title = HTML("<h2><b>Loan Installment Calculator</b></h4>"),
                    ...
                    tabPanel(h3("About app & Documentation"),
                             mainPanel(
                                     ...
                                     HTML("<h4><b>The presentation about the app can be found <a href='https://rpubs.com/radutoma-upt/ReproduciblePitch'>here</a>.<b/></h4>"),
                                     HTML("<h4><b>The app files can be found <a href='https://github.com/radutoma-upt/LoanCalculator'>here</a>.<b/></h4>"),
                                     HTML("<br/>"),
